...
read= a._Utility.getNode('MPA_settings').getNode("VDDPST_enable").read()
a._hw.dispatch()
print "VDDPST_enable" + str(read)
read= a._Utility.getNode('MPA_settings').getNode("DVDD_enable").read()
a._hw.dispatch()
print "DVDD_enable" + str(read)
read= a._Utility.getNode('MPA_settings').getNode("AVDD_enable").read()
a._hw.dispatch()
print "AVDD_enable" + str(read)
read= a._Utility.getNode('MPA_settings').getNode("PVDD_enable").read()
a._hw.dispatch()
print "PVDD_enable" + str(read)
read= a._Utility.getNode('MPA_settings').getNode("VBIAS_enable").read()
a._hw.dispatch()
print "VBIAS_enable" + str(read)
read= a._Utility.getNode("DAC_register").read()
a._hw.dispatch()
