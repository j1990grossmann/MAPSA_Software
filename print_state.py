...
a._hw.getNode("Configuration").getNode('num_MPA').write(6)
a._hw.dispatch()
read = a._hw.getNode("Configuration").getNode('num_MPA').read()
a._hw.dispatch()
print "num_MPA " + str(read)

read= a._hw.getNonde('Utility').getNode('MPA_settings').getNode("VDDPST_enable").read()
a._hw.dispatch()
print "VDDPST_enable" + str(read)
read= a._hw.getNonde('Utility').getNode('MPA_settings').getNode("DVDD_enable").read()
a._hw.dispatch()
print "DVDD_enable" + str(read)
read= a._hw.getNonde('Utility').getNode('MPA_settings').getNode("AVDD_enable").read()
a._hw.dispatch()
print "AVDD_enable" + str(read)
read= a._hw.getNonde('Utility').getNode('MPA_settings').getNode("PVDD_enable").read()
a._hw.dispatch()
print "PVDD_enable" + str(read)
read= a._hw.getNonde('Utility').getNode('MPA_settings').getNode("VBIAS_enable").read()
a._hw.dispatch()
print "VBIAS_enable" + str(read)
read= a._hw.getNonde('Utility').getNode("DAC_register").read()
a._hw.dispatch()
print "DAC_register" + str(read)
