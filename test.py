...
a._hw.getNode("Configuration").getNode('num_MPA').write(0x5)
a._hw.dispatch()
read = a._hw.getNode("Configuration").getNode('num_MPA').read()
a._hw.dispatch()
print "num_MPA " + str(read)
a._hw.getNode("Configuration").getNode('mode').write(0x4)
a._hw.dispatch()
#read = a._hw.getNode("Configuration").getNode('mode').read()
#a._hw.dispatch()
#print "mode " + str(read)
